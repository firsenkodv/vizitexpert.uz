...
return [
    ...
    */
    ...
    'services' => [
        ...
        // Ролик YouTube (www.youtube.com/embed) в блоке «Почему выбирают нас?»
        // на главной и в блоке «Преимущества» лендинга «О нас».
        // При выключении вместо плеера выводится плашка-заглушка.
        'youtube' => env('EXTERNAL_YOUTUBE'),

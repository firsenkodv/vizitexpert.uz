...
/**
 * v2: Dump2Resource::indexFields().
 * Директория загрузки — 'dump', как и в v2 (общая с DumpResource).
 *
 * @extends IndexPage<Dump2Resource>
 */
class Dump2IndexPage extends IndexPage
{
    /**

<div class="dashboardBox dashboardBox__a_user ">
    ...
    <div class="c__title_subtitle pad_t21_important">
        <h3 class="F_h1">{{ __('Свободные менеджеры') }}</h3>
        <div class="F_h2 pad_t5"><span>{{__('Набор в команду. Руководителя отдела продаж - ')}} <b>{{ $item->name }}</b></span></div>
    </div>

   @include('dashboard.forms.edit_senior_managers_plus')

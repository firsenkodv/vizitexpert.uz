                ...
                @if($manager->fixed_manager->id == $item->id )
                    <div
                        class="a_user__row a_user
                         @if(!$manager->published) published_0 @endif  @if(role($manager->id) == 'manager' or role($manager->id) == 'senior') background_green @endif @if(role($manager->id) == 'admin') background_biruza @endif">

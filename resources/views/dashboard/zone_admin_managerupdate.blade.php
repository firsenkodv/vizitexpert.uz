                ...
                <div class="cabinet__right">
                    ...
                    <div class="cabinet_radius12_fff">
                        ...
                        <div class="c__title_subtitle">
                            ...
                            <div class="F_h2 pad_t5"><span>{{__('Страница менеджера')}}</span></div>
                        </div>

                        @include('dashboard.managers.manager_update')
                    ...
                    <div class="cabinet_radius12_fff">
                        ...
                        @include('dashboard.forms.edit_reserve_manager',['managers'=> $managers ])
                    ...
                    <div class="cabinet_radius12_fff" id="cabinetManager_usersSearch">
                        ...
                        @include('dashboard.managers.manager_subusers')

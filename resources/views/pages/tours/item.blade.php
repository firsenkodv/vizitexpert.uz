{{-- Страница тура. Контент рисует шаблон, выбранный у тура в админке
     (App\Enums\Resources\ItemTemplate): pages/tours/templates/item/*.blade.php --}}

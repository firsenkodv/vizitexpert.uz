...
return [
    ...
    'attributes' => [
        ...
        'price' => '"Стоимость"',
        'payment_desc' => '"Введите номер и дату договора: Пример: № 02/05 от 07.11.2025 г."',

        'user_id'        => '"Клиент"',
        'city_departure' => '"Город вылета"',
        'city_arrival'   => '"Город прилета"',
        'date_departure' => '"Дата вылета"',
        'date_arrival'   => '"Дата прилета"',
        'days_count'     => '"Количество дней"',
        'hotel_id'       => '"Отель"',
        'hotel_custom'   => '"Отель (вручную)"',
        'tour_price'     => '"Стоимость тура"',
